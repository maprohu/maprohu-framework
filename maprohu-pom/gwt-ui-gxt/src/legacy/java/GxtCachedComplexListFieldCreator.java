...
public class GxtCachedComplexListFieldCreator implements CachedComplexListFieldCreator {

	@Override
	public <V> FocusableManagedWidget cachedComplexListField(
		...
		return new GxtCachedComplexListField<V>(value, editing, store, modelKeyProvider, labelProvider);
	}

	private static class GxtCachedComplexListField<V> implements FocusableManagedWidget{
